...
public class FlyingSalt extends Effect {
	...
	public FlyingSalt(GameState g, Point p, int vX, int vY) {
		super(g, p);
		vectorLength = Math.sqrt(vX * vX + vY * vY);
		this.towerImage = ResourceLoader.getLoader().getImage("resources/salt_crystals.png");
	 ...
	 */
	public void update() {
		position.x += (vX * 0.00001); // Change FlyingSalt Speed
		position.y += (vY * 0.00001);
		frameCounter++;
